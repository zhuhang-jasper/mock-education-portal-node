...
const errorCode = {
    ...
    /* CTI SERVER/INFRA/DB ERRORS : 4XX */
    UNKNOWN_EXCEPTION: {
        code: "400",
    ...
    /* CTI APPLICATION ERRORS / INTERNAL : 5XX */
    ERR_UNCAUGHT_EXCEPTION: {
        code: "500",
        message: "Unexpected exception in CTI application"
    },
    // ERR_BULK_OPERATION: {
    //     code: "501",
    //     message: "Failure in CTI bulk operation"
    // },
    ...
    /* CTI POSITIVE ERROR MESSAGES : 100 */
